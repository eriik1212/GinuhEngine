...
void C_Camera::PrintGui()
{
	...
	{
		ImGui::TextColored(ImVec4(255, 255, 0, 255), "Enabled: "); ImGui::SameLine(); ImGui::Checkbox("##cameraEnabled", &enabled);
		...
		if (ImGui::Button("Remove Component ##camera", ImVec2(ImGui::GetWindowSize().x, 20.0f)))
