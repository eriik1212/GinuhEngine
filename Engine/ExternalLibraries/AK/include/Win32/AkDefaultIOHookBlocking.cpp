...
AKRESULT CAkDefaultIOHookBlocking::OutputSearchedPaths(
...
{
	return CAkMultipleFileLocation::OutputSearchedPaths(in_pszFileName, in_pFlags, in_eOpenMode, out_searchedPath, in_pathSize);
}
...
{
	return CAkMultipleFileLocation::OutputSearchedPaths(in_fileID, in_pFlags, in_eOpenMode, out_searchedPath, in_pathSize);
}
...
{
	return CAkFileHelpers::CloseFile( in_fileDesc );
}
